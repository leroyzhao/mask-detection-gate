NOTE: following documentation and most of code is obtained from Chandrika Deb, from the following [repo](https://github.com/chandrikadeb7/Face-Mask-Detection). Code in detect_mask_video.py has been modified.
